module.exports = [
      {
        ...
        description: "Magic Kingdom Park, previously known as Walt Disney World Magic Kingdom (1971–1994) and The Magic Kingdom (1994–2017), is a theme park at the Walt Disney World Resort in Bay Lake, Florida, near Orlando, Florida. Owned and operated by The Walt Disney Company through its Parks, Experiences and Products division, the park opened on October 1, 1971, as 'Walt Disney World Magic Kingdom', the first of four theme parks at the resort. The park was initialized by Walt Disney and designed by WED Enterprises. Its layout and attractions are based on Disneyland Park in Anaheim, California, and are dedicated to fairy tales and Disney characters. The park is represented by Cinderella Castle, inspired by the fairy tale castle featured in the 1950 film. In 2019, the park hosted 20.9 million visitors, making it the most visited theme park in the world for the thirteenth consecutive year and the most visited theme park in North America for at least the past nineteen years.",
        location: 'Orlando, Florida',
        img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Under_the_Sea_Journey_of_the_Little_Mermaid_-_Magic_Kingdom.jpg/440px-Under_the_Sea_Journey_of_the_Little_Mermaid_-_Magic_Kingdom.jpg',
      },
      {
        id: 2,
      ...
      },
      {
        ...
        description: "Six Flags Over Georgia is a 290-acre (1.2 km2) theme park located in Mableton, Georgia. Opened in 1967, it is the second park in the Six Flags chain following the original Six Flags Over Texas, which opened in 1961. Six Flags Over Georgia is one of three parks in the Six Flags chain to have been founded by Angus G. Wynne. As with other Six Flags parks, it features themes from the Warner Bros. Entertainment library, including characters from Looney Tunes and DC Comics.",
        location: 'Austell, Georgia',
        img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Batman_%281st_Loop%29.JPG/200px-Batman_%281st_Loop%29.JPG',
      },
      {
        id: 9,
        name: "Hersheypark",
        description: "In 1903, Milton S. Hershey, founder of the Hershey Chocolate Company, surveyed the town that would become Hershey. Included in his plans was a site along Spring Creek that would be suitable for a leisure park for Hershey employees. In 1905, a bridge was built over Spring Creek, and a pavilion was built on the hill that overlooked it. While the bridge was able to be constructed, the land on the banks of Spring Creek, from Derry Church to Union Deposit, and areas further north of the creek (including the area currently occupied by Hersheypark Arena and Stadium) was then owned by J.H. Nissley. In February 1906, Hershey purchased all but two tracts of land, near Union Deposit, from Nissley. In early spring, the Hershey baseball club staked out an area for a baseball field; a baseball diamond, a track surrounding the field, and grandstands were built. The first game was played on May 5, which was a 4–0 loss to Felton Athletic Club. This is also noted as the first open-air event in Hershey.",
        location: 'Hershey, Pennsylvania',
        img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Sunken_Garden_%28Hersheypark%29.jpg/440px-Sunken_Garden_%28Hersheypark%29.jpg',
      },
      {
        id: 10,
        name: "Kings Island",
        ...
        location: 'Mason, Ohio',
        img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Diamondback.jpg/480px-Diamondback.jpg',
      },
